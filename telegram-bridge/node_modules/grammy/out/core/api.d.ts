...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    sendRichMessageDraft(chat_id: number, draft_id: number, rich_message: InputRichMessage, other?: Other<R, "sendRichMessageDraft", "chat_id" | "draft_id" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**

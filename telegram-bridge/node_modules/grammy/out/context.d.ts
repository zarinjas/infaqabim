...
export declare class Context implements RenamedUpdate {
     ...
     */
    replyWithRichMessageDraft(rich_message: InputRichMessage, other?: Other<"sendRichMessageDraft", "chat_id" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**
